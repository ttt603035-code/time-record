...
/**
 * shadcn/ui Chart (new-york-v4), ported to JSX.
 *
 * Two adjustments for this project:
 *   - Tailwind v4 arbitrary-property syntax (`bg-(--color-bg)`) is written as
 *     v3 arbitrary values (`bg-[--color-bg]`), since we are on Tailwind v3.
 *   - `aspect-video` is not forced; the donut is square, so callers set their
 *     own sizing.
 */
