...
export const I18N = {
  en: {
    ...
    manageData: 'Manage by category',
    manageDataDesc:
      'Delete events straight from the list — one by one, or a whole category at once. '
      + 'With Cloud Sync on, the next sync removes them on your other devices too.',
    noCategory: 'No category',
    manageDeleteAll: 'Delete all',
    manageDeleteTitle: 'Delete %n events?',
    manageDeleteMsg: 'Every event in "%s" will be permanently removed.',
    manageDeleted: 'Deleted %n events',
    deleteAria: 'Delete %s',
  ...
  zh: {
    ...
    manageData: '按分类管理',
    manageDataDesc:
      '在列表里直接删除日程 — 可逐条删除，也可整个分类一起删。开启云同步后，下次同步会同步移除其他设备上的这些日程。',
    noCategory: '未分类',
    manageDeleteAll: '全部删除',
    manageDeleteTitle: '删除 %n 条日程？',
    manageDeleteMsg: '「%s」下的所有日程将被永久删除。',
    manageDeleted: '已删除 %n 条日程',
    deleteAria: '删除 %s',
