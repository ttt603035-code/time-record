...
export const I18N = {
  en: {
    ...
    guideFormatTitle: 'Set each variable\u2019s format by tapping it',
    guideFormatDate: 'Date \u2192 Custom \u00b7 yyyy-MM-dd',
    guideFormatTime: 'Time \u2192 Custom \u00b7 HH:mm (24-hour)',
  ...
  zh: {
    ...
    guideFormatTitle: '点按变量，设置格式',
    guideFormatDate: '日期 \u2192 自定 \u00b7 yyyy-MM-dd',
    guideFormatTime: '时间 \u2192 自定 \u00b7 HH:mm（24 小时制）',
