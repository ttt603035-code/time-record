...
export const I18N = {
  en: {
    ...
    syncSetupSql: 'Create the table', syncSetupSqlDesc:
      'Run this once in your Supabase SQL editor before the first sync.',
    syncSecurityNote:
      'The anon key is public by design. Anyone who has it can read this table, '
      + 'so use a project you own and keep nothing sensitive here.',
  ...
  zh: {
    ...
    syncSetupSql: '创建数据表', syncSetupSqlDesc:
      '首次同步前，在 Supabase 的 SQL Editor 里执行一次。',
    syncSecurityNote:
      'Anon key 本身就是公开的，拿到它的人都能读这张表。请使用你自己的项目，不要存放敏感内容。',
